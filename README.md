# bookMyShowClone
Basic Clone of BookMyShow movie booking app

Hello folks, we will be creating our own movie ticket booking application just like BookMyShow. You have to design & build the backend for the application and the ability for the users to register and book tickets.
...
https://github.com/azaylamba/bookMyShowClone 
